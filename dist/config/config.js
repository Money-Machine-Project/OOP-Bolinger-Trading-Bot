...
dotenv.config();
const config = {
    appkey: process.env.TRADING_STATUS === "virtual"
        ? process.env.APP_KEY_VIRTUAL
        : process.env.APP_KEY_REAL,
    appsecret: process.env.TRADING_STATUS === "virtual"
        ? process.env.APP_SECRET_VIRTUAL
        : process.env.APP_SECRET_REAL,
    frontAccount: process.env.TRADING_STATUS === "virtual"
        ? process.env.FRONT_ACCOUNT_VIRTUAL
        : process.env.FRONT_ACCOUNT_REAL,
    backAccount: process.env.TRADING_STATUS === "virtual"
    ...
    baseUrl: process.env.TRADING_STATUS === "virtual"
