 ...
 */
const dayResultScheduler = (symbol, symbolInverse) => {
        ...
        try {
            ...
            await retryOperation(async () => {
                ...
                await sendMail("TRADING_RESULT", {
                    ...
                    result: Number(todayBalance.output2[0].asst_icdc_erng_rt).toFixed(2),
                });
                await resultInsert(today, Number(todayBalance.output2[0].tot_evlu_amt), todayBalance.output2[0].asst_icdc_erng_rt.toFixed(2));
            }, 3, 1000); // 최대 3번 재시도, 5초 간격
        }
        catch (error) {
